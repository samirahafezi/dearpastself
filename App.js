...
const SEED_ADVICE = [
  { id: 's1', forAge: 16, fromAge: 34, text: "Stop worrying so much about what others think. The people whose opinions keep you up at night will barely register in your memory ten years from now. Wear the weird shoes. Say the strange thing.", author: 'Someone who finally figured it out', sig: '', createdAt: Date.now() - 86400000 * 3 },
  ...
  { id: 's3', forAge: 27, fromAge: 41, text: "It's okay not to have it figured out. The people who seem certain are just better at performing certainty. Uncertainty is not a flaw — it's the beginning of every interesting thing that ever happened to you.", author: 'Your future self', sig: '', createdAt: Date.now() - 86400000 },
  { id: 's4', forAge: 13, fromAge: 29, text: "The awkwardness you feel right now is not permanent. You are growing into yourself, and that is an uncomfortable, beautiful process. Everyone else is equally confused — they're just hiding it too.", author: 'Anonymous', sig: 'A late bloomer who bloomed', createdAt: Date.now() - 86400000 * 5 },
  { id: 's5', forAge: 32, fromAge: 58, text: "Sleep when the baby sleeps. Let the dishes sit. The laundry will always exist. This season won't. You will not remember the mess. You will remember the weight of that small head on your chest.", author: 'A parent looking back', sig: 'Three kids, zero regrets', createdAt: Date.now() - 86400000 * 7 },
];
